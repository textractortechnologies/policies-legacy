...
3. The training session focuses on, but is not limited to, the following subjects defined in Textractor ‘s security policies and procedures:
	...
	5. Auditing.  Textractor may monitor access and activities of all users;
	6. Workstations may only be used to perform assigned job responsibilities;
	7. Users may not download software onto Textractor’s workstations and/or systems without prior approval from the Security Officer;
	8. Users are required to report malicious software to the Security Officer immediately;
	9. Users are required to report unauthorized attempts, uses of, and theft of Textractor’s systems and/or workstations;
	...
	12. Users may not alter ePHI maintained in a database, unless authorized to do so by a Textractor Customer;
	13. Users are required to understand their role in Textractor’s contingency plan;
...
The Security Officer is responsible for facilitating the training and supervision of all workforce members [164.308(a)(3)(ii)(A) and 164.308(a)(5)(ii)(A)], investigation and sanctioning of any workforce member that is in violation of Textractor security policies and non-compliance with the security regulations [164.308(a)(1)(ii)(c)], and writing, implementing, and maintaining all polices, procedures, and documentation related to efforts toward security and compliance [164.316(a-b)].
...
The Security Officer, in collaboration with the Privacy Officer, is responsible for facilitating the development, implementation, and oversight of all activities pertaining to Textractor’s efforts to be compliant with the HIPAA Security Regulations, and any other security and compliance frameworks.  The intent of the Security Officer Responsibilities is to maintain the confidentiality, integrity, and availability of ePHI.  These organizational responsibilities include, but are not limited to the following:
...
11. Maintains a program promoting workforce members to report non-compliance with policies and procedures.
	...
	2. Applies consistent and appropriate sanctions against workforce members who fail to comply with the security policies and procedures of Textractor.
	3. Mitigates, to the extent practicable, any harmful effect known to Textractor of a use or disclosure of ePHI in violation of Textractor’s policies and procedures, even if effect is the result of actions of Textractor business associates, customers, and/or partners.

12. Reports security efforts and incidents to administration immediately upon discovery. Responsibilities in the case of a known ePHI breach are documented in the [Textractor Breach Policy](./#breach).
...
13. The Security Officer facilitates the communication of security updates and reminders to all workforce members to which it pertains.  Examples of security updates and reminders include, but are not limited to:
	...
	2. Textractor’s requirement to report unauthorized attempts to access ePHI;
...
1. The Security Officer promptly facilitates a thorough investigation of all reported violations of Textractor’s security policies and procedures.  The Security Officer may request the assistance from others.
	...
	4. Provide individuals suspected of non-compliance of the Security rule and/or Textractor’s policies and procedures the opportunity to explain their actions.
...
2. Violation of any security policy or procedure by workforce members may result in corrective disciplinary action, up to and including termination of employment.  Violation of this policy and procedures by others, including business associates, customers, and partners may result in termination of the relationship and/or associated privileges.  Violation may also result in civil and criminal penalties as determined by federal and state laws and regulations.
  8. A violation resulting in a breach of confidentiality (i.e. release of PHI to an unauthorized individual), change of the integrity of any ePHI, or inability to access any ePHI by other users, requires immediate termination of the workforce member from Textractor.
...
4. In the case of an insider threat, the Security Officer and Privacy Officer are to setup a team to investigate and mitigate the risk of insider malicious activity. Textractor workforce members are encouraged to come forward with information about insider threats, and can do so anonymously.
